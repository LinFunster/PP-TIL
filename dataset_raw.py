...
if __name__ == "__main__": 
    ...
    parser.add_argument('--name', default='train',type=str, help='path to dataset files') 
    parser.add_argument('--load_path', default='/data/lin_funster/waymo_dataset/',type=str, help='path to dataset files')
    parser.add_argument('--save_path',  default='/data/lin_funster/waymo_dataset/',type=str,help='path to save processed data')
    ...
    save_path = args.save_path + 'raw_' + args.name 
